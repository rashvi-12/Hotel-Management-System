...
public class Project extends JFrame implements ActionListener
{
	...
	Project(String atype,String meter)
	{
		...
		depositdetails.setMnemonic('O');
		depositdetails.addActionListener(this);
		depositdetails.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,ActionEvent.CTRL_MASK));
		...
		JMenuItem billdetails = new JMenuItem(" Bill Details");
		 ...
		 ImageIcon icon8=new ImageIcon(ClassLoader.getSystemResource("icon/icon4.png"));
